...
def main():
    parser = argparse.ArgumentParser(description='Train GIN model for molecular property prediction')
    parser.add_argument(
        '--config',
        type=str,
    ...
    print("=" * 70)
    print("GIN Molecular Property Prediction - Training")
    print("=" * 70)
    ...
    model_dir = project_root / output_config.get('model_dir', 'models/gin_model')
    ...
    # Save metrics
    metrics_path = model_dir / 'gin_model_metrics.txt'
    metrics_to_save = {
